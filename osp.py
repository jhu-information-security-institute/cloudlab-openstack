...
grafanaInstructions = ""
if params.release in [ "pike","queens","rocky","stein","train","ussuri","victoria","wallaby","xena","yoga","zed","bobcat","antelope","caracal" ]:
...
if params.release == "juno":
    ...
    image_tag_rel = '-Z'
elif params.release == 'antelope':
    image_os = 'UBUNTU22-64'
    image_tag_rel = '-A'
elif params.release == 'bobcat':
    image_os = 'UBUNTU22-64'
    image_tag_rel = '-B'    
elif params.release == 'caracal':
    image_os = 'UBUNTU22-64'
    image_tag_rel = '-C'    
else:
    image_os = 'UBUNTU18-64'
...
if params.release in [ "victoria", "wallaby", "xena", "yoga", "zed", "antelope", "bobcat", "caracal" ]:
    fromScratch = True
    doAptDistUpgrade = True
    doAptUpdate = True
...
if fromScratch:
    ...
    image_tag_cn = '-OSCN'
    image_tag_nm = '-OSNM'
    if params.release in [ 'rocky','stein','train','ussuri','victoria','wallaby','xena','yoga','zed','antelope','bobcat','caracal' ]:
...
if params.osNodeType == 'ibm8335':
    ...
    if params.release not in [ 'queens','rocky','stein','train','ussuri','victoria','wallaby','xena','yoga','zed','antelope','bobcat','caracal' ]:
